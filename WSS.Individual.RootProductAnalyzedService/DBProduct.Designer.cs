...
namespace WSS.Individual.RootProductAnalyzedService {
    ...
    public partial class DBProduct : global::System.Data.DataSet {
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductRow AddProductRow(long ID, string Name, string ImagePath) {
...
namespace WSS.Individual.RootProductAnalyzedService.DBProductTableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Product] WHERE (([ID] = @Original_ID) AND ((@IsNull_Name = 1 AND [Na" +
                "me] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_ImagePath = 1 AND [Imag" +
                "ePath] IS NULL) OR ([ImagePath] = @Original_ImagePath)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Product] ([ID], [Name], [ImagePath]) VALUES (@ID, @Name, @ImagePath)" +
                ";\r\nSELECT ID, Name, ImagePath FROM Product WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Product] SET [ID] = @ID, [Name] = @Name, [ImagePath] = @ImagePath WHERE (([ID] = @Original_ID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_ImagePath = 1 AND [ImagePath] IS NULL) OR ([ImagePath] = @Original_ImagePath)));
SELECT ID, Name, ImagePath FROM Product WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        ID, Name, ImagePath\r\nFROM            Product";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        ID, Name, ImagePath\r\nFROM            Product\r\nWHERE        (ID = @I" +
                "D)";
        ...
        public virtual int FillById(DBProduct.ProductDataTable dataTable, long ID) {
        ...
        public virtual int Delete(long Original_ID, string Original_Name, string Original_ImagePath) {
        ...
        public virtual int Insert(long ID, string Name, string ImagePath) {
        ...
        public virtual int Update(long ID, string Name, string ImagePath, long Original_ID, string Original_Name, string Original_ImagePath) {
            ...
            if ((Original_ImagePath == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_ImagePath));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string ImagePath, long Original_ID, string Original_Name, string Original_ImagePath) {
