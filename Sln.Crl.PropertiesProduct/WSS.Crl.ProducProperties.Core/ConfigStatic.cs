...
namespace WSS.Crl.ProducProperties.Core
{
    public class ConfigStatic
    {
        ...
        public static string KeyRabbitMqCrlProductProperties = "rabbitMqCrlProperties";

        public static string GetQueueWaitDownloadHtml(string domain)
        {
            return string.Format("Crl.Properties.DownloadHtml.{0}", domain);
        }
        ...
        {
            return string.Format("Crl.Properties.Parse.{0}", domain);
        }
    }
}
