...
namespace WSS.Crl.ProducProperties.Core
{
    ...
    {
        public static string ProductPropertyConnection = "Data Source=192.168.100.178;Initial Catalog=ProductPropery;Persist Security Info=True;User ID=sa;Password=123456a@;connection timeout=200";
