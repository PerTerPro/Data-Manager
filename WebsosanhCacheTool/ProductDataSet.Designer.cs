...
namespace WebsosanhCacheTool {
    ...
    public partial class ProductDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductRow AddProductRow(long ID, int Price, int ProductID, string Name, string ImageUrls) {
...
namespace WebsosanhCacheTool.ProductDataSetTableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Product] WHERE (([ID] = @Original_ID) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ((@IsNull_ProductID = 1 AND [ProductID] IS NULL) OR ([ProductID] = @Original_ProductID)) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_ImageUrls = 1 AND [ImageUrls] IS NULL) OR ([ImageUrls] = @Original_ImageUrls)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Product] ([ID], [Price], [ProductID], [Name], [ImageUrls]) VALUES (@" +
                "ID, @Price, @ProductID, @Name, @ImageUrls);\r\nSELECT ID, Price, ProductID, Name, " +
                "ImageUrls FROM Product WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Product] SET [ID] = @ID, [Price] = @Price, [ProductID] = @ProductID, [Name] = @Name, [ImageUrls] = @ImageUrls WHERE (([ID] = @Original_ID) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ((@IsNull_ProductID = 1 AND [ProductID] IS NULL) OR ([ProductID] = @Original_ProductID)) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_ImageUrls = 1 AND [ImageUrls] IS NULL) OR ([ImageUrls] = @Original_ImageUrls)));
SELECT ID, Price, ProductID, Name, ImageUrls FROM Product WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WebsosanhCacheTool.Properties.Settings.Default.QT_2_FPTConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        ID, Price, ProductID, Name, ImageUrls\r\nFROM            Product\r\nWHE" +
                "RE        (Company = @companyID) AND (Valid = 1) AND (IsBlackList IS NULL OR  Is" +
                "BlackList  = 0)";
        ...
        public virtual ProductDataSet.ProductDataTable GetAllProductName(global::System.Nullable<long> companyID) {
