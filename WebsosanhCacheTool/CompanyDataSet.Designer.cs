...
namespace WebsosanhCacheTool {
    ...
    public partial class CompanyDataSet : global::System.Data.DataSet {
        ...
        public partial class CompanyDataTable : global::System.Data.TypedTableBase<CompanyRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CompanyRow AddCompanyRow(long ID, string Domain) {
...
namespace WebsosanhCacheTool.CompanyDataSetTableAdapters {
    ...
    public partial class CompanyTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Company] ([ID], [Domain]) VALUES (@ID, @Domain);\r\nSELECT ID, Domain " +
                "FROM Company WHERE (ID = @ID) ORDER BY TotalValid DESC";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Company] SET [ID] = @ID, [Domain] = @Domain WHERE (([ID] = @Original_ID) " +
                "AND ((@IsNull_Domain = 1 AND [Domain] IS NULL) OR ([Domain] = @Original_Domain))" +
                ");\r\nSELECT ID, Domain FROM Company WHERE (ID = @ID) ORDER BY TotalValid DESC";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        ID, Domain\r\nFROM            Company\r\nWHERE        (ID <> 6619858476" +
                "258121218) AND (TotalValid > 0) AND (Status <> 2)\r\nORDER BY TotalValid DESC";
        ...
        public virtual CompanyDataSet.CompanyDataTable GetAllCompanies() {
