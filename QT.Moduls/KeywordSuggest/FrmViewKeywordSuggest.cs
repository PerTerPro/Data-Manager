...
namespace QT.Moduls.KeywordSuggest
{
    ...
    public partial class FrmViewKeywordSuggest : Form
    {
        SqlDb sqldb = new SqlDb(QT.Entities.Server.ConnectionString);
        public FrmViewKeywordSuggest()
        {
            InitializeComponent();
        }
        ...
        {
            FrmChartMaxVolume frm = new FrmChartMaxVolume();
            frm.ShowDialog();
        }

        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            FrmViewHistoryVolume frm = new FrmViewHistoryVolume();
            frm.ShowDialog();
        }
    }
}
