...
{
    public partial class FrmDetailConfigRunCrawler : Form
    {
        public FrmDetailConfigRunCrawler()
        {
            InitializeComponent();
        ...
        private void config_run_crawlerBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            ...
            //FrmDetailConfigRunCrawler.ActiveForm.Close();
        }

        private void FrmDetailConfigRunCrawler_Load(object sender, EventArgs e)
        {
