...
namespace QT.Moduls {
    ...
    public partial class QT_2DataSet : global::System.Data.DataSet {
        ...
        public partial class ListClassificationDataTable : global::System.Data.TypedTableBase<ListClassificationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ListClassificationRow AddListClassificationRow(string Name, int ParentID) {
...
namespace QT.Moduls.QT_2DataSetTableAdapters {
    ...
    public partial class ListClassificationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[ListClassification] WHERE (([ID] = @Original_ID) AND ((@IsNull" +
                "_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Parent" +
                "ID = 1 AND [ParentID] IS NULL) OR ([ParentID] = @Original_ParentID)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[ListClassification] ([Name], [ParentID]) VALUES (@Name, @Paren" +
                "tID);\r\nSELECT ID, Name, ParentID FROM ListClassification WHERE (ID = SCOPE_IDENT" +
                "ITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[ListClassification] SET [Name] = @Name, [ParentID] = @ParentID WHERE (([ID] = @Original_ID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_ParentID = 1 AND [ParentID] IS NULL) OR ([ParentID] = @Original_ParentID)));
SELECT ID, Name, ParentID FROM ListClassification WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QT.Moduls.Properties.Settings.Default.QT_2ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, ParentID FROM dbo.ListClassification";
        ...
        public virtual int Fill(QT_2DataSet.ListClassificationDataTable dataTable) {
        ...
        public virtual QT_2DataSet.ListClassificationDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QT_2DataSet.ListClassificationDataTable dataTable = new QT_2DataSet.ListClassificationDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QT_2DataSet.ListClassificationDataTable dataTable) {
