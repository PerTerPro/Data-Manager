    ...
    public class MenuCompanyPlus : ContextMenuStrip
    {
        ...
        public void Init()
        {
            ...
            if (eventGetCompanys != null)
            {
                ...
                {
                    Text = @"PushDownloadHtm",TextImageRelation = TextImageRelation.ImageBeforeText
                };
        ...
        private void ClickPushToDownloadImage(object sender, EventArgs e)
        {
            ...
            var pa = new ProductAdapter(new SqlDb(QT.Entities.Server.ConnectionString));MQPushDownloadImage mqPushDownloadImage = new MQPushDownloadImage();
