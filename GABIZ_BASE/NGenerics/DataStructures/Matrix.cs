...
namespace GABIZ.Base.NGenerics.DataStructures
{
    ...
    public class Matrix : IVisitableCollection<double>, ICloneable, IMathematicalMatrix
    {
        ...
        {
            return this.GetSubMatrix(rowStart, columnStart, rowCount, columnCount);
        }
        ...
        IMathematicalMatrix IMathematicalMatrix.Times(IMathematicalMatrix matrix)
        {
            ...
            return this.Times((Matrix)matrix);
        }
        ...
        IMathematicalMatrix IMathematicalMatrix.Plus(IMathematicalMatrix matrix)
        {
            ...
            return this.Plus((Matrix)matrix);
        }
        ...
        IMathematicalMatrix IMathematicalMatrix.Minus(IMathematicalMatrix matrix)
        {
            ...
            return this.Minus((Matrix)matrix);
        }
        ...
        public double[] GetRow(int rowIndex)
        {
            ...
            double[] ret = new double[noOfColumns];
        ...
        public double[] GetColumn(int columnIndex)
        {
            ...
            double[] ret = new double[noOfRows];
        ...
        public void AddRows(int rowCount)
        {
            ...
            double[,] newData = new double[newRowCount, noOfColumns];
        ...
        public void AddColumns(int columnCount)
        {
            ...
            // Create a new matrix of the specified size
            double[,] newData = new double[noOfRows, newColumnCount];
        ...
        public void Resize(int newNumberOfRows, int newNumberOfColumns)
        {
            ...
            double[,] newData = new double[newNumberOfRows, newNumberOfColumns];
        ...
        public void Accept(NGenerics.Visitors.IVisitor<double> visitor)
        {
            if (visitor == null)
            {
