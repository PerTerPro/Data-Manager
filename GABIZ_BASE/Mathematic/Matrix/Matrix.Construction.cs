...
namespace GABIZ.Base.Mathematic
{
    ...
    using GABIZ.Base.Mathematic.Random;
    ...
    public static partial class Matrix
    {
        ...
        public static double[,] Random(int size, bool symmetric, double minValue, double maxValue)
        {
            ...
            if (!symmetric)
            {
                for (int i = 0; i < size; i++)
                    for (int j = 0; j < size; j++)
                        matrix[i, j] = GABIZ.Base.Mathematic.Tools.Random.NextDouble() * (maxValue - minValue) + minValue;
            }
            else
            {
                for (int i = 0; i < size; i++)
        ...
        public static double[] Random(int size, double minValue, double maxValue)
        {
            ...
            for (int i = 0; i < size; i++)
                vector[i] = GABIZ.Base.Mathematic.Tools.Random.NextDouble() * (maxValue - minValue) + minValue;
