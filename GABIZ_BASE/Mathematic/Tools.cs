namespace GABIZ.Base.Mathematic
{
    ...
    public static class Tools
    {
        ...
        ///   internally by the GABIZ.Base.NET classes and methods.
        /// </summary>
        ...
        public static double Angle(IntPoint previous, IntPoint next)
        {
            ...
            return GABIZ.Base.Mathematic.Tools.Angle(dx, dy);
        }
        ...
        public static int Direction(IntPoint previous, IntPoint next)
        {
            ...
            double radians = GABIZ.Base.Mathematic.Tools.Angle(dx, dy);
