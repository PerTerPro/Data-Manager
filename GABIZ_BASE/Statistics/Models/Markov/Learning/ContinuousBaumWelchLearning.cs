...
namespace GABIZ.Base.Statistics.Models.Markov.Learning
{
    ...
    public class ContinuousBaumWelchLearning : BaumWelchLearningBase, IUnsupervisedLearning
    {
        ...
        public new double Run(params Array[] observations)
        {
            ...
            {
                this.samples = (Array)GABIZ.Base.Mathematic.Matrix.Combine(
                    GABIZ.Base.Mathematic.Matrix.Combine(continuousObservations));
            }
            else
            {
                this.samples = (Array)GABIZ.Base.Mathematic.Matrix.Combine(continuousObservations);
            }
