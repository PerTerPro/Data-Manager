...
namespace GABIZ.Base.Statistics.Models.Markov.Topology
{
    using System;
    ...
    /// <seealso cref="GABIZ.Base.Statistics.Models.Markov.Topology.ITopology"/>
    /// <seealso cref="GABIZ.Base.Statistics.Models.Markov.Topology.Forward"/>
    /// <seealso cref="GABIZ.Base.Statistics.Models.Markov.Topology.Custom"/>
    /// 
    /// <example>
    ///  <para>
            ...
            if (random)
            {
                ...
                for (int i = 0; i < states; i++)
                {
                    ...
                    for (int j = 0; j < states; j++)
                        sum += A[i, j] = GABIZ.Base.Mathematic.Tools.Random.NextDouble();
