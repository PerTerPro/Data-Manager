...
{
    using System;
    using GABIZ.Base.Statistics.Distributions;
    using GABIZ.Base.Statistics.Distributions.Univariate;
    using GABIZ.Base.Statistics.Models.Markov.Topology;
    ...
    ///   as <see cref="GABIZ.Base.Statistics.Distributions.Univariate.NormalDistribution">Gaussian</see>
    ///   <see cref="GABIZ.Base.Statistics.Distributions.Univariate.Mixture{T}">Mixture Model</see>)
    ...
    ///  
    ///  <para>
    ///   If a <see cref="GABIZ.Base.Statistics.Distributions.Univariate.GeneralDiscreteDistribution">general
    ...
    public class ContinuousHiddenMarkovModel : HiddenMarkovModelBase, IHiddenMarkovModel
    {
            ...
            : base(new Custom(transitions, probabilities))
        {
            ...
            for (int i = 0; i < B.Length; i++)
                B[i] = new GeneralDiscreteDistribution(GABIZ.Base.Mathematic.Matrix.GetRow(emissions, i));
        ...
        private double[][] convert(Array array)
        {
            ...
            if (univariate != null) return GABIZ.Base.Mathematic.Matrix.Split(univariate, Dimension);
