namespace GABIZ.Base.Statistics
{
    using System;
    ...
    public static class Tools
    {
        ...
        {
            return System.Math.Sqrt(WeightedVariance(values, weights, mean));
        }
        ...
        ///   double[] means = GABIZ.Base.Statistics.Tools.Mean(matrix);
        ///   </code>
        /// </example>
        ...
        ///   
        ///   // column means are equal to (4.5, -0.25, 7.0)
        ///   double[] colMeans = GABIZ.Base.Statistics.Tools.Mean(matrix, 0);
        ///     
        ///   // row means are equal to (2.0, 5.5)
        ///   double[] rowMeans = GABIZ.Base.Statistics.Tools.Mean(matrix, 1);
        ///   </code>
        /// </example>
        ...
        {
            Random random = GABIZ.Base.Mathematic.Tools.Random;
