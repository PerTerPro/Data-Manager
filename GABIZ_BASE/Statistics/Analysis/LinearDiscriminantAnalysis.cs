...
namespace GABIZ.Base.Statistics.Analysis
{
    ...
    public class LinearDiscriminantAnalysis : IDiscriminantAnalysis, IProjectionAnalysis
    {
        ...
        public virtual void Compute()
        {
            ...
            Means = GABIZ.Base.Statistics.Tools.Mean(source);
            StandardDeviations = GABIZ.Base.Statistics.Tools.StandardDeviation(source, totalMeans);
            ...
            for (int c = 0; c < Classes.Count; c++)
            {
                ...
                // Get the class mean
                double[] mean = GABIZ.Base.Statistics.Tools.Mean(subset);


                // Continue constructing the Within-Class Scatter Matrix
                double[,] Swi = GABIZ.Base.Statistics.Tools.Scatter(subset, mean, (double)count);
                ...
                this.classStdDevs[c] = GABIZ.Base.Statistics.Tools.StandardDeviation(subset, mean);
            }
    ...
    public class DiscriminantAnalysisClass
    {
        ...
        {
            get { return analysis.Source.Submatrix(Indexes); }
        }
