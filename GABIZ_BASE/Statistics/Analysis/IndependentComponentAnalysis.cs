...
namespace GABIZ.Base.Statistics.Analysis
{
    ...
    using GABIZ.Base.Statistics.Analysis.ContrastFunctions;
    ...
    public class IndependentComponentAnalysis : IMultivariateAnalysis
    {
        ...
        public IndependentComponentAnalysis(double[,] data, AnalysisMethod method, IndependentComponentAlgorithm algorithm)
        {
            ...
            this.columnMeans = GABIZ.Base.Statistics.Tools.Mean(sourceMatrix);
            this.columnStdDev = GABIZ.Base.Statistics.Tools.StandardDeviation(sourceMatrix, columnMeans);
        }
        #endregion
        ...
        public void Compute(int components)
        {
            ...
            double[,] whiten = GABIZ.Base.Statistics.Tools.Whitening(matrix, out whiteningMatrix);
