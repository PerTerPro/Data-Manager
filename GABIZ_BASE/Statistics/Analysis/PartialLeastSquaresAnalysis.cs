...
namespace GABIZ.Base.Statistics.Analysis
{
    ...
    using GABIZ.Base.Statistics.Models.Regression.Linear;
    ...
    public class PartialLeastSquaresAnalysis : IMultipleRegressionAnalysis, IProjectionAnalysis
    {
        ...
        public PartialLeastSquaresAnalysis(double[,] inputs, double[,] outputs, AnalysisMethod method, PartialLeastSquaresAlgorithm algorithm)
        {
            ...
            this.meanX = GABIZ.Base.Statistics.Tools.Mean(inputs);
            this.meanY = GABIZ.Base.Statistics.Tools.Mean(outputs);
            this.stdDevX = GABIZ.Base.Statistics.Tools.StandardDeviation(inputs, meanX);
            this.stdDevY = GABIZ.Base.Statistics.Tools.StandardDeviation(outputs, meanY);
