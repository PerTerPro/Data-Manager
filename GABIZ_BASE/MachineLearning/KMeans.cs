namespace GABIZ.Base.MachineLearning
{
    ...
    public class KMeans
    {
        ...
        public KMeans(int k)
            : this(k, GABIZ.Base.Mathematic.Distance.SquareEuclidean)
        {
        }
        ...
        /// use the <see cref="GABIZ.Base.Math.Distance.SquareEuclidean"/> distance.</param>
        ...
        public void Randomize(double[][] data)
        {
            ...
            int[] idx = GABIZ.Base.Statistics.Tools.Random(data.Length, K);
        ...
        public int[] Compute(double[][] data, double threshold)
        {
            ...
            for (int i = 0; i < k; i++)
            {
                ...
                if (sub.Length > 0)
                {
                    ...
                    covariances[i] = GABIZ.Base.Statistics.Tools.Covariance(sub, centroids[i]);
                }
                else
                {
