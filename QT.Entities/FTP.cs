...
namespace QT.Entities
{
    public class FTP
    {
        ...
        /* Download File */
        public static void DownloadFile(string host, string user, string password, string remoteFile, string localFile)
        {
            try
            {
        ...
        public static bool CheckFileExists(string host, string user, string password,string remoteFile)
        {
            /* Create an FTP Request */
            FtpWebRequest ftpRequest = (FtpWebRequest)FtpWebRequest.Create(host + "/" + remoteFile);
            /* Log in to the FTP Server with the User Name and Password Provided */
        ...
        /* Upload File */
        public static bool UploadFile(string host, string user, string password, string remoteFile, string localFile)
        {
            bool check = false;
            try
            {
        ...
        /* Delete File */
        public static bool DeleteFile(string host, string user, string password, string deleteFile)
        {
            try
            {
                /* Create an FTP Request */
        ...
        public static bool CreateDirectory(string host, string user, string password, string newDirectory)
        {
            bool check = false;
            try
            {
